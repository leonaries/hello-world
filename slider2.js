    ...
    var slider = {
        init:function(obj){
            ...
            function addPointBlock(){
                ...
                $(".sliderPoint").css("z-index",imgArg.length+2).html(pointNode);
            ...
            function addArrowBlock(){
                var arrowBlock = '<div class="sliderArrow"> ' +
                    '<span class="toPre"><img src="images/toPre.png" alt=""></span> ' +
                    '<span class="toNext"><img src="images/toNext.png" alt=""></span> ' +
                    '</div>';
